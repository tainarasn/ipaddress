...
export const Circuit: React.FC<CircuitProps> = ({}) => {
    ...
    return (
        <div className="anim">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="100% 100% 100% 100%" style={{ zIndex: 0 }}>
                <g fill="none" fill-rule="evenodd">
                    ...
                    />
                    <path stroke="#8D3B0E" d="M8 127.82v391.06a4.04 4.04 0 0 0 4 4.04L140.8 524" />
                    <path
                        stroke="#8D3B0E"
                    ...
                    />
                    <path stroke="#8D3B0E" d="M633.41 278.74l-21.36-21.22a5.45 5.45 0 0 1-1.4-3.35V-78.58" />
                    <path
                        stroke="#8D3B0E"
